...
with st.spinner('Analysis in progress...'):
    ...
    if your_home == 'Yes':
        ...
        with st.spinner('Selecting machine learning model_name...'):
        ...
        st.success('Machine learning model training complete')
    ...
    if your_team == home_team:
        ...
        if prediction_home ==  1:
            st.markdown('## Result: ')
            st.markdown('## <span style="color:blue">WIN ~> Probability of winning is: ' + str(prediction_prob_home[0][1]))
        else:
            st.markdown('## Result: ')
            st.markdown('## <span style="color:red">LOSE ~> Probability of losing is: ' + str(prediction_prob_home[0][0]))
        st.markdown(str(best_model_home) + ' --> ' + str(models[best_model_home]) + ' --> ' + 'Test accuracy: ' + str(test_accuracy_home))
        st.markdown('###')
    ...
    if your_team == away_team:
        ...
        if prediction_away ==  1:
            st.markdown('## Result: ')
            st.markdown('## <span style="color:blue">WIN ~> Probability of winning is: ' + str(prediction_prob_away[0][1]))
        else:
            st.markdown('## Result: ')
            st.markdown('## <span style="color:red">LOSE ~> Probability of losing is: ' + str(prediction_prob_away[0][0]))
        st.markdown(str(best_model_away) + ' --> ' + str(models[best_model_away]) + ' --> ' + 'Test accuracy: ' + str(test_accuracy_away))
        st.markdown('###')
